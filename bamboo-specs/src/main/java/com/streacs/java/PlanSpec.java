...
public class PlanSpec {
    ...
    Plan createPlan() {
        return new Plan(
            ...
            .description("Plan created from (https://scm.streacs.com/projects/DCK/repos/streacs_atlassian_bitbucket)")
            .triggers(
        ...
        return new VcsCheckoutTask()
            ...
            .checkoutItems(new CheckoutItem()
                .repository(new VcsRepositoryIdentifier()
                    .name("DCK - STREACS Atlassian Bitbucket (master)")
                )
            );
    }
